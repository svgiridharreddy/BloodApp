...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { Address: @register.Address, Blood-Group: @register.Blood-Group, Name: @register.Name, Phone: @register.Phone } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { Address: @register.Address, Blood-Group: @register.Blood-Group, Name: @register.Name, Phone: @register.Phone } }
